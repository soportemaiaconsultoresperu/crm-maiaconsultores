...
class CourseActivityFactory extends Factory{protected $model=CourseActivity::class;public function definition():array{return ['type'=>CourseActivityType::Course,'code'=>fake()->unique()->bothify('CUR-###'),'name'=>fake()->sentence(3),'slug'=>fake()->unique()->slug(),'official_academic_hours'=>'8.00','base_syllabus_json'=>['Temario base'],'talk_includes_certificate'=>false,'talk_certificate_price'=>'0.00','is_active'=>true];}}
