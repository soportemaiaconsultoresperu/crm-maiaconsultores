...
/*
    Spanish (Perú) validation messages — CRM Maia Consultores.
    Covers the rules used by the application; unknown rules fall back
    to English (APP_FALLBACK_LOCALE). Extend per module as needed.
*/
...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El campo :attribute apareció en una filtración de datos. Elija un valor diferente.',
    ],
