...
/**
 * Validates the commercial document email payload: the edited recipient and the
 ...
 * operation key, writes the ledger row and hands the message to the transport.
 * The ability checked here is the same one the route requires, so a rendered
 * control never answers 403.
 */
class SendCommercialDocumentEmailRequest extends FormRequest
{
